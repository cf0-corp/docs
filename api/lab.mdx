---
title: "Lab API: start and manage research sessions"
...
<ParamField body="budget_cap" type="number">
  Maximum spend in USD for this query. Range: 0.01–10.0. Defaults to 6.0.
</ParamField>
...
Lists the files in your CF0 workspace: uploads, artifacts, skills, memories, and sessions. Returns a response with `private` (your personal files) and `shared` (org-shared files) sections.

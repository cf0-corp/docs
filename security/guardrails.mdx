---
title: "Guardrails"
description: "Defense in depth in cf0 — deterministic code computes numbers, sandboxes isolate execution, schemas validate model output, missing inputs are not fabricated."
